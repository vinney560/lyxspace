const CACHE_NAME = 'lyxspace-cache-v2';
const DYNAMIC_CACHE = 'lyxspace-dynamic-v1';
const OFFLINE_URL = '/offline.html';
const STATIC_PAGES = ['/', '/files', OFFLINE_URL];
...
self.addEventListener('fetch', event => {
  ...
  // Fully offline /my-courses
  if(reqUrl.pathname.startsWith(MY_COURSES)) {
    event.respondWith(
